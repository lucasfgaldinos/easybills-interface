					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
						<div>
							<h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
								...
								<span className="text-emerald-600">EasyBills</span>
							</h1>
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
							{cardContent.map((cardContent) => (
								<div
									...
									className="bg-gray-800/50 p-6 rounded-xl hover:shadow-lg"
								>
									<div className="mb-4 bg-green-500/10 p-3 rounded-full inline-block">
										{cardContent.icon}
									</div>
									<h3 className="text-xl font-bold text-white mb-2">
										{cardContent.title}
									</h3>
									<p className="text-gray-400">{cardContent.description}</p>
								</div>
							))}
						</div>
					</div>
